...
// function Education() {
//   // const sampleEducation = ["Kwame Nkrumah UNiversity", "University of Ghana"];
...
//   // handles the changes in the input fiels
//   // function handleEducationInputChange(index, value) {
//   //   const newEducationList = [...educationInput];
//   //   newEducationList[index].name = value;
//   //   setEducationInput(newEducationList);
//   // }
...
//       location: "",
//     }
//     setEducationFormData([...educationFormData, newFields])
//     if (!displayNewForm) setDisplayNewForm(true);

//     setToggle(false);
//   }
//   // function to handle input changes in new form
//   //////
...
//   // function to save education form input

//   function saveEducationForm(e) {
//     // Create a new education object with all form fields
//     e.preventDefault();
//     const newEducation = {
//       school: educationFormData.school || educationInput,
...
//     };
//     // Add the new education object to the educationInput array
...
//     //   location: "",
//     // });
//     // Log the updated education data
...
//           >
//             <form>
//               {educationFormData.map((index, item) => (
//                 <div key={index}>
...
//                     onChange={(e) => {
//                       const { value } = e.target;
//                       setEducationInput(value); // Update educationInput
//                       setEducationFormData((prevData) => ({
//                         ...prevData,
//                         school: value, // Update educationFormData.school with the new value
//                       }));
//                     }}
//                   />
...
//                     value={item.degree}
//                     onChange={(e) =>
//                       handleEducationFormInputChange(e, "degree")
//                     }
//                   />
...
//                     onChange={(e) =>
//                       handleEducationFormInputChange(e, "startDate")
//                     }
//                   />
...
//                     value={item.endDate}
//                     onChange={(e) =>
//                       handleEducationFormInputChange(e, "endDate")
//                     }
//                   />
...
//                     value={item.location}
//                     onChange={(e) =>
//                       handleEducationFormInputChange(e, "location")
//                     }
//                   />
...
//             type="text"
//             onChange={(e) => handleEducationInputChange(e.target.value)}
//             //the index is from the map index above to specify where to effect the changes
